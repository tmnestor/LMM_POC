...
class BankStatementClassifier:
    ...
    def classify_statement_structure(
        ...
        if verbose:
            rprint(f"[cyan]🏦 Classifying bank statement structure: {image_name}[/cyan]")
    ...
    def _classify_by_filename(self, image_name: str) -> Literal["flat", "date_grouped"]:
        ...
        flat_indicators = [
            "flat", "simple", "basic", "straightforward"
        ]
        
        # Date-grouped statement indicators  
        grouped_indicators = [
            "statement_001", "complex", "grouped", "sectioned"
        ]
    ...
    def _display_classification_result(
        self, 
        structure_type: Literal["flat", "date_grouped"], 
        image_name: str
    ):
    ...
    def get_structure_info(self, structure_type: Literal["flat", "date_grouped"]) -> Dict:
