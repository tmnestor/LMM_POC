...
DATA_DIR=$(_kfp_or "${image_dir:-}" "../evaluation_data/bank")
OUTPUT_DIR=$(_kfp_or "${output:-}" "../evaluation_data/output")
GROUND_TRUTH=$(_kfp_or "${ground_truth:-}" "../evaluation_data/bank/ground_truth_bank.csv")
LOG_DIR=$(_kfp_or "${LMM_LOG_DIR:-}" "../evaluation_data/output/logs")
