...
class LlavaTableExtractor:
    ...
    def extract_table(self, image_path: str, prompt_template: str) -> Dict[str, Any]:
        """Extract structured data from table image using LLaVA"""
        # Load and preprocess image
        image = Image.open(image_path)
    ...
    def _parse_response(self, response: str) -> Dict[str, Any]:
        ...
        # JSON parsing, table extraction, validation, etc.
        pass

# Usage example for LLaVA
extractor = LlavaTableExtractor("llava-hf/llava-v1.6-mistral-7b-hf")
result = extractor.extract_table("bank_statement.png", BANK_STATEMENT_PROMPT)
```
