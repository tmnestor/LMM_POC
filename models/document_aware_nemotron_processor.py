...
NEMOTRON_GENERATION_CONFIG = dict(QWEN3VL_GENERATION_CONFIG)


class DocumentAwareNemotronProcessor(BaseDocumentProcessor):
    ...
    def __init__(
        ...
        if self.debug:
            print(f"Nemotron processor initialized for {self.field_count} fields")
    ...
    def _configure_generation(self) -> None:
        ...
        self.gen_config: dict[str, Any] = dict(NEMOTRON_GENERATION_CONFIG)
