...
**Auto-Generated from Notebook**: 2025-12-17 15:17:24
...
|-------|---------|-----------|-----------|--------|----------|--------------|------------|
| **Llama-3.2-Vision-11B** | 0.8823 | 1.0000 | 0.8624 | 0.9032 | 97.64% | 76.4s | 0.8 docs/min |
| **InternVL3-8B** | 0.8663 | 0.9286 | 0.8947 | 0.8397 | 84.86% | 46.3s | 1.3 docs/min |
| **InternVL3-2B** | 0.7644 | 0.7273 | 0.8397 | 0.7016 | 71.37% | 12.5s | 4.8 docs/min |

### Key Findings

**Winner (F1 Score)**: Llama-3.2-Vision-11B

**Highest Precision**: InternVL3-8B (0.8947)

**Highest Recall**: Llama-3.2-Vision-11B (0.9032)

**Fastest**: InternVL3-2B (12.5s)
...
|-------|-----------|--------------|--------------|------------|------------|
| PAYER_ADDRESS | 0.0% | 0.0% | 0.0% | IVL3-2B | 100.0% |
| DOCUMENT_TYPE | 0.0% | 0.0% | 0.0% | IVL3-2B | 100.0% |
| TOTAL_AMOUNT | 0.0% | 0.0% | 0.0% | IVL3-2B | 100.0% |
| STATEMENT_DATE_RANGE | 0.0% | 0.0% | 0.0% | IVL3-2B | 100.0% |
| PAYER_NAME | 0.0% | 0.0% | 0.0% | IVL3-2B | 100.0% |
| BUSINESS_ABN | 0.0% | 0.0% | 0.0% | IVL3-8B | 100.0% |
| GST_AMOUNT | 0.0% | 0.0% | 0.0% | IVL3-8B | 100.0% |
| LINE_ITEM_PRICES | 0.0% | 0.0% | 0.0% | IVL3-8B | 100.0% |
| SUPPLIER_NAME | 0.0% | 0.0% | 0.0% | IVL3-2B | 85.7% |
| LINE_ITEM_QUANTITIES | 0.0% | 0.0% | 0.0% | Llama-11B | 100.0% |
| LINE_ITEM_TOTAL_PRICES | 0.0% | 0.0% | 0.0% | Llama-11B | 100.0% |
| INVOICE_DATE | 0.0% | 0.0% | 0.0% | IVL3-2B | 83.3% |
| BUSINESS_ADDRESS | 0.0% | 0.0% | 0.0% | IVL3-8B | 83.3% |
| LINE_ITEM_DESCRIPTIONS | 0.0% | 0.0% | 0.0% | Llama-11B | 99.3% |
| TRANSACTION_DATES | 0.0% | 0.0% | 0.0% | Llama-11B | 97.8% |
| IS_GST_INCLUDED | 0.0% | 0.0% | 0.0% | Llama-11B | 100.0% |
| TRANSACTION_AMOUNTS_PAID | 0.0% | 0.0% | 0.0% | IVL3-8B | 66.7% |
...
| **InternVL3-8B** | 0.0% | 0/17 | SECONDARY |
| **InternVL3-2B** | 0.0% | 0/17 | NO SPECIALIZATION |
...
- **Fastest processing**: InternVL3-2B (~12.5s/doc)
...
**Choose HIGH PRECISION Model (InternVL3-8B: 89.47%) if:**
...
|-------|-----------|--------|----|----|
| **Llama-3.2-Vision-11B** | 86.24% | 90.32% | 0.8823 | 🏆 Best Recall🏆 Best F1 |
| **InternVL3-8B** | 89.47% | 83.97% | 0.8663 | 🏆 Best Precision |
| **InternVL3-2B** | 83.97% | 70.16% | 0.7644 |  |

**Key Insights:**
- **Precision Leader**: InternVL3-8B (89.47%)
- **Recall Leader**: Llama-3.2-Vision-11B (90.32%)
- **F1 Leader**: Llama-3.2-Vision-11B (0.8823)
...
|-------|--------------|-----------|------------|------------------|
| **Llama-3.2-Vision-11B** | 97.64% | 76.4s | 0.8 docs/min | 76.7 |
| **InternVL3-8B** | 84.86% | 46.3s | 1.3 docs/min | 109.9 |
| **InternVL3-2B** | 71.37% | 12.5s | 4.8 docs/min | 343.3 |

**Highest Efficiency**: InternVL3-2B
