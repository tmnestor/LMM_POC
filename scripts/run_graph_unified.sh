#!/usr/bin/env bash
# Run the 3-stage unified extraction pipeline (classify + extract in one graph).
# No separate classification stage -- the graph handles it.
# Usage: bash scripts/run_graph_unified.sh
set -euo pipefail
...
ARTIFACTS="../evaluation_data/artifacts/graph_unified"
GROUND_TRUTH="../evaluation_data/bank/ground_truth_bank.csv"

# ---------------------------------------------------------------------------
# Clean previous outputs
# ---------------------------------------------------------------------------
echo "=== Cleaning previous graph_unified outputs ==="
...
# ---------------------------------------------------------------------------
# Stage 1+2: Classify + Extract (GPU) -- unified graph
# ---------------------------------------------------------------------------
echo "=== Stage 1+2: Unified classify + extract ==="
