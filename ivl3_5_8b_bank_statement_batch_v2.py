#!/usr/bin/env python
"""
InternVL3.5-8B Bank Statement Batch Extraction and Evaluation - V2
...
Usage:
    python ivl3_5_8b_bank_statement_batch_v2.py [OPTIONS]
...
def generate_reports(batch_results, output_dir):
    ...
    if CONFIG["GENERATE_CSV"] and successful:
        ...
        csv_path = output_dir / f"ivl3_5_8b_bank_v2_{BATCH_TIMESTAMP}.csv"
    ...
    if CONFIG["GENERATE_JSON"]:
        ...
        json_path = output_dir / f"ivl3_5_8b_bank_v2_{BATCH_TIMESTAMP}.json"
    ...
    if CONFIG["GENERATE_MARKDOWN"] and successful:
        ...
        md_path = output_dir / f"ivl3_5_8b_bank_v2_{BATCH_TIMESTAMP}.md"
...
def main():
    parser = argparse.ArgumentParser(
        description="Batch extraction and evaluation of bank statements with InternVL3.5-8B (V2)"
    )
    parser.add_argument(
    ...
    log_rule("[bold blue]INTERNVL3.5-8B BANK STATEMENT V2 - BALANCE DESCRIPTION")
